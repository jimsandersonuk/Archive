...
//	AccelStepper stepper = AccelStepper(forwardstep2, backwardstep2);	// wrap the stepper in an AccelStepper object
	...
	*/
	...
	void decideMenu (int inpSelMenuMenu)
	{
    ...
    void displaySubMenuA (int dispMenu)
    {
        ...
        switch (dispMenu)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                displaySubMenuBFooter = String(F ("4 Clear Tracks"));
        ...
        switch (selectSubMenu)
        {
            ...
            case 2:
              for (int i = 0; i < 7; i++)
              {
                ...
                break;
            case 3:
                selectSubMenuBHeader = String(F ("Reset Memory"));
                displayOutput(false, selectSubMenuBHeader, selectSubMenuBFooter);
                clearEEPROM();
                delay(2000);
                selectSubMenuBFooter = String(F ("Memory wiped"));
                displayOutput(false, selectSubMenuBHeader, selectSubMenuBFooter);
                resetMenu(2, 3);
                break;
    ...
    void displaySubMenuB (int dispMenu)
    {
        ...
        switch (dispMenu)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                displaySubMenuBFooter = String(F ("3 Main Menu"));
                displayOutput(false, displaySubMenuBHeader, displaySubMenuBFooter);
                break;
