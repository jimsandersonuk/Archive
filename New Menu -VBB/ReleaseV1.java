...
//	AccelStepper stepper = AccelStepper(forwardstep2, backwardstep2);	// wrap the stepper in an AccelStepper object
	...
	*/
	...
	void readArrayEEPROM ()
	{
		...
		{
			int returnArray = EEPROMReadlong(i);
...
/*
	...
	void BasicAccDecoderPacket_Handler (int address, boolean activate, byte data)	// Basic accessory packet handler
	{
		...
		for (int i = 0; i < ( int ) (sizeof(gAddresses) / sizeof(gAddresses[0])); i++)
		{
			...
			{
		str1 = String ("DCC addr: ");
		str2 = String (address, DEC);
		str3 = String ("	Head/Tail = (1/0) : ");
...
*/
	...
	void displayMainMenu (int dispMenu)
	{
		...
		switch (dispMenu)
		{
			...
			case 1:
				...
				break;
			case 2:
				displayMainMenuFooter = String("3 Turntable Menu");
				displayOutput(false,displayMainMenuHeader, displayMainMenuFooter);
				break;
			case 3:
				displayMainMenuFooter = String("4 Setup Menu");
				displayOutput(false,displayMainMenuHeader, displayMainMenuFooter);
				break;
   ...
   //	>>>>	START	 ------------------	LCD Menu - Turntable Setup Menu	 ------------------
	...
	void displaySubMenuA (int dispMenu)
	{
		...
		displaySubMenuAHeader = String ("Turntable Menu");

		switch (dispMenu)
		{
			case 0:
				displaySubMenuAFooter = String ("1 Setup Tracks");
				displayOutput (false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 1:
				displaySubMenuAFooter = String ("2 Check Tracks");
				displayOutput (false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 2:
				displaySubMenuAFooter = String ("3 Track Settings");
				displayOutput (false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 3:
				displaySubMenuAFooter = String("4 Clear Tracks");
				displayOutput(false, displaySubMenuAHeader, displaySubMenuAFooter);
				break;
			case 4:
	...
	void selectSubMenuA (int selectSubMenu)
	{
		...
		switch (selectSubMenu)
		{
			case 0:		//	Setup Tracks
				...
				break;
			case 1:
				selectSubMenuAHeader = String ("Verify Tracks");
				displayOutput (false, selectSubMenuAHeader, selectSubMenuAFooter);
				newMenu = true;
				stayInMenu = true;
				do
	...
	void displaySubMenuB (int dispMenu)
	{
		...
		displaySubMenuBHeader = String("Setup Menu");

		switch (dispMenu)
		{
			case 0:
				displaySubMenuBFooter = String("1 Calibration");
				displayOutput(false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
			case 1:
				displaySubMenuBFooter = String("2 Debug Mode");
				displayOutput(false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
			case 2:
				displaySubMenuBFooter = String("3 Main Menu");
				displayOutput(false, displaySubMenuBHeader, displaySubMenuBFooter);
				break;
	...
	void selectSubMenuB (int selectSubMenu)
	{
		...
		{
			case 0:
				selectSubMenuBHeader = String("Set Calibration");
		   ...
		   case 1:
				selectSubMenuBHeader = String("Debug Mode");
				displayOutput(false, selectSubMenuBHeader, selectSubMenuBFooter);
				newMenu = true;
				...
				stayInMenu = true;
					...
					{
						isDebugMode = true;
						selectSubMenuBFooter = String("Debug mode on");
						displayOutput(false, selectSubMenuBHeader, selectSubMenuBFooter);
					}
...
//					String("	Actual Current Position: ");
//					str2 = String(stepper.currentPosition());	// shows the position value corrected.
					...
					//release the motor
//				  release2();
				   // str1 = String("	Brake Set & Motor Released ");
