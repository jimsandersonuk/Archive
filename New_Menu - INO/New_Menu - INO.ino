...
*/
	...
	#include <utility\Adafruit_PWMServoDriver.h>	  // <Adafruit_PWMServoDriver.h>
...
//	  stepperTimer ();
	...
	void checkTrackMove ()
	{
		tableTargetPosition = 0;
			...
			{
				tableTargetTrack = i;
				tableTargetPosition = PositionTrack[i];
	...
	void selectProgrammedTargetTracks()
	{
		...
		if (newMenu)
		{
			currentTurntablePosition (false, currentStepPosition);
			key = -1;
		}
